...
type LoadBalancerSpec struct {
	...
	// Type defines the type of Loadbalancer. It could be one of lb11, lb21, or lb31.
	// +optional
...
// LoadBalancerStatus defines the observed state of the control plane loadbalancer.
